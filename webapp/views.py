...
def about(request):
    ...
    context = {'meta_title': 'About Combine Design | Transforming Spaces',
                'team_list':team_list, 'testimonials' : testimonials ,
...
def our_work_detail(request, id):
    ...
    context = {
        'our_work_detail': our_work_detail , 'our_work_images':our_work_images ,
...
def product_detail(request , id):
    ...
    context = {
        'product_detail': product_detail , 'product_list':product_list ,
...
def post_detail(request, id):
	...
	context = {
		'post_detail':post_detail , 'categories' : categories , 'comments': comments , 
